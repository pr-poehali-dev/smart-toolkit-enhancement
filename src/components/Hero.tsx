        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full w-fit">
              ...
              <span className="text-sm font-medium">Профессиональное обучение операторов</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight text-balance">
              Стань специалистом по управлению БПЛА
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Комплексное обучение от практикующих экспертов. Освойте пилотирование дронов, 
              аэрофотосъёмку и законодательство — и войди в одну из самых перспективных профессий.
            </p>
          ...
          <div className="relative h-96 md:h-full min-h-96">
            ...
            <img
              src="https://cdn.poehali.dev/projects/021e652e-b116-408f-8fb8-186cc7b22d02/files/e34cf080-3aab-44e7-883c-627724feb0b9.jpg"
              alt="Обучение оператора БПЛА"
